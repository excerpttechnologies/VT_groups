        ...
        <div className="flex h-16 flex-col justify-center border-b border-sidebar-border px-4 pt-2 pb-2">
          {!collapsed ? (
            <Link href="/" className="flex items-center gap-2">
              <Image src="/VT-Groups-v2.png" alt="VT Groups Logo" width={48} height={48} className="h-12 w-auto object-contain" style={{ width: 'auto', height: '100%' }} />
            ...
            <Image src="/VT-Groups-v2.png" alt="Logo" width={32} height={32} className="mx-auto h-8 w-8 object-contain" style={{ width: 'auto', height: 'auto' }} />
          )}
